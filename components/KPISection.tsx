  ...
  return (
    <div
      style={{
        ...
        border: '1px solid rgba(159,39,67,0.2)',
        borderRadius: '1.25rem',
        padding: '1.75rem 1.5rem',
        boxShadow: '0 4px 24px rgba(0,0,0,0.07), inset 0 0 0 1px rgba(159,39,67,0.12)',
        display: 'flex',
    ...
    >
      ...
      <div style={{
        ...
        background: 'linear-gradient(90deg, transparent, #9F2743, #F9A14B, transparent)',
...
export default function KPISection() {
  ...
  return (
    ...
    >
      ...
      <div aria-hidden style={{ position:'absolute', inset:0, pointerEvents:'none', background:'radial-gradient(ellipse 65% 50% at 80% 15%, rgba(249,161,75,0.1) 0%, transparent 65%)' }} />
      ...
      <div style={{ position:'relative', zIndex:1, maxWidth:'90rem', margin:'0 auto', padding:'0 2rem' }}>
        ...
        <div style={{ textAlign:'center', marginBottom:'3.5rem', ...fadeUp(isVisible, 0) }}>
          <p style={{ fontSize:'clamp(0.62rem,0.9vw,0.78rem)', fontWeight:700, letterSpacing:'0.32em', textTransform:'uppercase', color:'#9F2743', marginBottom:'0.8rem', opacity:0.85 }}>
          ...
          <h2 style={{ fontSize:'clamp(2rem,4vw,3rem)', fontWeight:900, textTransform:'uppercase', color:'#0d1f35', letterSpacing:'-0.02em', margin:'0 0 0.5rem' }}>
            Key Performance
            <span style={{ background:'linear-gradient(90deg,#9F2743,#F9A14B)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}> Indicators</span>
          </h2>
